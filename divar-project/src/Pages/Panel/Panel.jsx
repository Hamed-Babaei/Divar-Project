...
<html lang="fa" dir="rtl">
  <head>
    ...
    <link
      rel="stylesheet"
      href="../../vendor/bootstrap_icon/bootstraicon.css"
    />
            ...
            <div className="sidebar">
              <div className="sidebar__user">
                ...
                <div className="sidebar__user-left">
                  ...
                  <div className="sidebar__user-phone">تلفن : 09023555555</div>
                </div>
              </div>
              ...
              <a className="sidebar__business sidebar__link-item" href="#">
                <i
                  className="sidebar__business-icon sidebar__link-icon bi bi-shop"
                ></i>
                دیوار برای کسب و کارها
              </a>
            ...
            <div className="verify">
              ...
              <div className="verify__nationality">
                ...
                <div className="verify__nationality-select">
                  <div className="verify__nationality-select-wrapper">
                    ...
                    >
                    <i
                      className="verify__nationality-select-icon bi bi-chevron-down"
                    ></i>
                  </div>
                  <ul className="verify__nationality-dropdown">
                    <li
                      className="verify__nationality-dropdown-item verify__nationality-dropdown-item--active"
                    >
                      ایرانی
                    </li>
              ...
              <div className="verify__national-code">
                ...
                <span className="verify__national-code-subtitle"
                  >لطفا کد ملی خود را وارد کنید.</span
                >
